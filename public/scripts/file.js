            ...
            if (escaped) {
                    ...
                    if (escapeCode.charAt(0) === "[") {
                        switch (escapeCode.charAt(escapeCode.length - 1)) {
                            ...
                            case "D":
                                ...
                                break;
                            case "H":
                                // Set the cursor position by calling setPos(), first <y>, then <x>.
                                if (values.length === 1) {
                                    setPos(1, values[0]);
                                } else {
                            ...
                            case "K":
                                ...
                                break;
                            case "m":
                                // Attributes, work through each code in turn.
                            ...
                            case "s":
                                ...
                                break;
                            case "u":
                                // Restore the current <x> and <y> positions.
                                x = savedX;
                                y = savedY;
                                break;
                        }
                ...
                switch (code) {
                    ...
                    case 13:
                        ...
                        break;
                    case 26:
                        // Ignore eof characters until the actual end-of-file, or sauce record has been reached.
                        break;
                    default:
...
var Save = function () {
    ...
    function encodeANSi(useUTF8) {
        ...
        for (var inputIndex = 0; inputIndex < rows * columns; inputIndex++) {
            ...
            if (useUTF8 === true) {
                getUTF8(charCode).forEach(function (utf8Code) {
    ...
    function xb() {
        ...
        output.set(new Uint8Array([88, 66, 73, 78, 26, columns & 255, columns >> 8, rows & 255, rows >> 8, font.getHeight(), flags]), 0);
